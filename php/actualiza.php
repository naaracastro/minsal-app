...
<body>
    ...
    <!-- zona de edicion -->
    <form class="containertable1 containertable111" action="procesar_actualizar.php" method="POST">
        <div class="table__tittle table__tittle--edit1"> Datos de Ususarios</div>
        ...
        <?php 
            ...
            <input type="text" class"table__input" value="<?php echo $row["rut"];?>" name="rut">
            <input type="text" class"table__input" value="<?php echo $row["telefono"];?>" name="telefono">
            <input type="text" class"table__input" value="<?php echo $row["codestab"];?>" name="codestab">
            <input type="text" class"table__input" value="<?php echo $row["contraseña"];?>" name="contrasena">
            <input type="text" class"table__input" value="<?php echo $row["correo"];?>" name="correo">

        <?php } mysqli_free_result($resultado); ?>
                <input type="submit" value="Modificar" class="sub1">
    </form>
        </div>
